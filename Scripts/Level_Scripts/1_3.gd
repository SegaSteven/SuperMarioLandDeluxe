...
# Pipe Settings
@export var scene_underground1 = "res://Scenes/Levels/1-3_Under.tscn"
@export var scene_underground2 = "res://Scenes/Levels/1-3_Under_2.tscn"
...
func _on_door_normal_level_completed_signal() -> void:
	GameManager.level_1_1_beaten = true


func _on_door_normal_2_level_completed_signal() -> void:
	GameManager.level_1_1_beaten = true
